...
public class SearchResult {
  ...
  private Map<String, List<Map<String, String>>> results = new HashMap<>();

  public SearchResult() {
  }

  public SearchResult results(@javax.annotation.Nullable Map<String, List<Map<String, String>>> results) {
  ...
  public void setResults(@javax.annotation.Nullable Map<String, List<Map<String, String>>> results) {
    this.results = results;
  }
